...
public class DatabaseHandler {
	...
	public void doReservation(String _cinema, String _movie, String _seats, String _name, String _mail, String _phone) throws Exception{
		initConnection();
		stmt.executeUpdate("INSERT INTO Reservations (Cinema, Movie, Seats, Name, Mail, Phone) VALUES (\""+_cinema+"\", \""+_movie+"\", \""+_seats+"\", \""+_name+"\", \""+_mail+"\", \""+_phone+"\")");
		closeConnection();
	}
	
	public void deleteReservation(String reservationID) throws Exception {
		initConnection();
		stmt.executeUpdate("DELETE FROM Reservations WHERE ID = " + reservationID );
		closeConnection();
	}
