...
public class Webservice extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(action.equals("getReservedSeats")){
			...
			try {
				int success = db.doReservation(request.getParameter("cinema"), request.getParameter("movie"), request.getParameter("seats"), request.getParameter("name"), request.getParameter("mail"), request.getParameter("phone"));
				out.println(success);
			} catch (Exception e) {
				out.println(e.toString());
			}
